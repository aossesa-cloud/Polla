 ...
 * Filtra por campa�as activas y fechas.
 */
    ...
    return (
      <div className={styles.container}>
        <div className={styles.filters}>
          ...
          <div className={styles.filterGroup}>
            <label className={styles.filterLabel}>Campa�a:</label>
            <div className={styles.campaignTabs}>
              ...
              {activeCampaignsForDisplay.length === 0 && (
                <span style={{ color: '#64748b', fontSize: '13px', padding: '8px' }}>
                  No hay campa�as para esta fecha
                </span>
              )}
            </div>
          </div>
        ...
        <div style={{ padding: 64, textAlign: 'center', color: '#9ca3af' }}>
          ...
          <p style={{ fontSize: 18 }}>
            No hay pron�sticos cargados
            {activeCampaigns.length === 0 ? ' en campa�as activas.' : selectedDate ? ` para ${selectedDate}.` : '.'}
          </p>
        </div>
      </div>
    )
